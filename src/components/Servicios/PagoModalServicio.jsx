...
export default function PagoModalServicio({
  isOpen,
  onClose,
  onConfirm,
  total,
  ...
  const handleConfirm = () => {
    ...
    const datosPago = {
      ...
      interes_sistema: interes?.montoInteres || 0,
      total_con_interes: total,
      interes_tarjeta: metodoPago === "tarjeta_credito" ? interesTarjeta : 0,
      ...
      >
        ...
        <DialogContent sx={{ p: 2.5, mt: 2 }}>
          ...
          >
            ...
            <Typography variant="h4" sx={{ fontWeight: 600, color: "#dc2626", mb: 1.5 }}>
            ...
            {metodoPago === "tarjeta_credito" && cuotasSeleccionadas && !pagoDividido && (
              ...
              >
                ...
                <Typography variant="caption" sx={{ color: "#92400e", display: "block", mt: 0.5, fontSize: "0.7rem" }}>
